...
import type { S_E_Map_Mesh, S_Settings, S_S_E_Map, S_S_E_Map_Config } from "@models";
...
export class Scene_Element_Map extends Scene_Element<S_S_E_Map, S_E_Map_Mesh[]> {
  ...
  constructor(public mapSettings: S_S_E_Map, public meshesTemplate: S_E_Map_Mesh[], public sceneSettings: S_Settings) {
