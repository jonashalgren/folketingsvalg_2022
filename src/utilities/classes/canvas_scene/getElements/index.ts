    ...
    .map((elementSettings, index) => {
      switch (elementSettings.type) {
        case C_S_Element_Type.BOX:
          return new Canvas_Scene_Element_Box({ elementSettings, elementMeshes: elementsMeshes.box, sceneSettings, index });
        case C_S_Element_Type.MAP:
          return new Canvas_Scene_Element_Map({ elementSettings, elementMeshes: elementsMeshes.map, sceneSettings });
        ...
        case C_S_Element_Type.FIGURE:
          return new Canvas_Scene_Element_Figure({ elementSettings, elementMeshes: elementsMeshes.figure, sceneSettings });
