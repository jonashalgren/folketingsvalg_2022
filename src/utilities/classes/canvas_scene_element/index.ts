...
export abstract class Canvas_Scene_Element<D extends C_S_S_Element, M extends C_S_E_Mesh[]> {
  abstract animate(progress: number, entryProgress: number): void;
  abstract update(elementSettings: D, sceneSettings: C_S_Settings): void;
  group: Group;
