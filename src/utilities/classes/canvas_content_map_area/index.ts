...
export class Canvas_Content_Map_Area {
  ...
  constructor(private areaId: C_C_S_Element_Map_Area_Id, private configs: C_S_S_E_Map_Config[], private meshes: C_C_E_Mesh_Map[], private contentSettings: C_Content_Settings) {
